...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  switch($act){  
    ...
    default:
      ...
      $query2 = "SELECT * FROM menu_tm WHERE id_menu=$r[id_parent]";
    ...
    case "tambahmenu":  
      echo "<h2>Tambah Menu</h1>
            ...
            <tr>
			   <td>Level Menu</td>
			   <td> : <select name=\"id_parent\">
					<option value=\"0\" selected>Menu Utama</option>";
              
                $query  = "SELECT * FROM menu_tm ORDER BY id_menu";
                $tampil = mysqli_query($konek, $query);
    ...
    // Form Edit Menu
    case "editmenu":
      $query = "SELECT * FROM menu_tm WHERE id_menu='$_GET[id]'";
      $hasil = mysqli_query($konek, $query);
      $r     = mysqlI_fetch_array($hasil);
		  
      echo "<h2>Edit Menu</h1>
