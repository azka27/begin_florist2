...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  if ($module=='templates' AND $act=='input'){
    ...
    $input = "INSERT INTO templates(nama_templates, folder) VALUES('$nama_templates', '$folder')";
  ...
  elseif ($module=='templates' AND $act=='update'){
    ...
    $update = "UPDATE templates SET nama_templates='$nama_templates', folder='$folder' WHERE id_templates='$id'";
