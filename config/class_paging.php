...
class paging_produk{
  ...
  function navHalaman($halaman_aktif, $jmlhalaman){
    ...
    if($halaman_aktif > 1){
	    ...
	    $link_halaman .= "<a href=\"halproduk-1.html\" class=\"page-numbers\">&laquo;</a>   
                        <a href=\"halproduk-$prev.html\" class=\"page-numbers\">&lsaquo;</a> ";
    }
    ...
    for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
      if ($i < 1) continue;
 	    $angka .= " <a href=\"halproduk-$i.html\" class=\"page-numbers\">$i</a> ";
    }
    ...
    for($i=$halaman_aktif+1; $i<($halaman_aktif+3); $i++){
      if($i > $jmlhalaman) break;
	    ...
	    $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... <a href=\"halproduk-$jmlhalaman.html\" class=\"page-numbers\">$jmlhalaman</a> " : " ");
    ...
    if($halaman_aktif < $jmlhalaman){
	    ...
	    $link_halaman .= " <a href=\"halproduk-$next.html\" class=\"page-numbers\">&rsaquo;</a>  
                         <a href=\"halproduk-$jmlhalaman.html\" class=\"page-numbers\">&raquo;</a> ";
    }
    return $link_halaman;
  }
}
